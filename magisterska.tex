...
Pametni števec imajo poleg funkcij za merjenje električne energije tudi vlogo zbiranja in pošiljanje podatkov iz drugih merilnih naprav v gospodinjstvu (npr. vodni števec, kalorimeter, števec plina) \cite{skalar_zasnova_nodate}. V večini primerov podatke iz drugih merilnih naprav zbirajo preko lokalnih žičnih in brezzičnih omrežij (M-Bus, wM-Bus, RS-485), agregiranje podatke pa nato pošljejo naprej preko komunikacije po elektroenergetskem omrežju (G3-PLC) ali pa preko mobilnega omrežja (GPRS,LTE-M, Nb-IoT). 
...
Poenostavljeno arhitekturo pametnega števca prikazuje slika \ref{blok_shema_stevec}.
