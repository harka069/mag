...
\end{figure}
\par
Preverili smo tudi delovanje funkcije \textit{last gasp}. Ultra kondenzator na števcu je napolnjen na napetost \SI{2}{\volt}, ob izpadu napajanja pa s pomočjo pretvornika navzgor napetost na ultra kondenzatorju dvignemo na 4V, blokovno shemo prikazuje slika \ref{blok_shema_napajanje_stevec}. Pretvornik navzgor svojo funkcijo opravlja dokler je napetost na ultra kondenzatorju vsaj \SI{0,5}{\volt} napetosti. Števec smo nastavili tako, da \SI{30}{\second} po izpadu napajanja pošlje sporočilo na izbrani naslov IP ter vrata preko protokola UDP. Na računalniku smo spremljali komunikacijo na določenem portu ter uspešno prejeli števčevo sporočilo, ob tem pa smo na osciloskopu spremljali napetost na števčnem kondenzatorju. Rezultate prikazuje slika \ref{last_gasp}, iz katere lahko odčitamo, da je po poslanem sporočilu na ultra kondenzatorju še dovolj energije, da se števec lahko varno ugasne.
\begin{figure}[!h]
    \centering
